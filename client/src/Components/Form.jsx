      ...
      <div>
        <form onSubmit={handleSubmit} className="formulario">
          ...
          <input
            className="input"
            type="number"
            Key={recipe.Puntuacion}
            value={recipe.Puntuacion}
            onChange={(e) =>
              setRecipe({ ...recipe, Puntuacion: parseInt(e.target.value) })
            }
          />
          ...
          <input
            className="input"
            type="number"
            Key={recipe.HealthScore}
            value={recipe.HealthScore}
            onChange={(e) =>
              setRecipe({ ...recipe, HealthScore: parseInt(e.target.value) })
            }
          />
          ...
          <select
            ...
            multiple={true}
            onChange={(e) =>
              setRecipe({ ...recipe, types: [...recipe.types, e.target.value] })
            }
            required
          >
            {options.map((k) => {
          ...
          <input
            type="submit"
            value="Submit"
            disabled={validator(recipe).length}
          />
        </form>
      </div>
    </div>
